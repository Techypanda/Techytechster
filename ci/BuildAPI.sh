...
sam deploy --template ./packaged-template.yaml --stack-name techytechsterwebapis --region ap-southeast-2 --capabilities CAPABILITY_IAM --parameter-overrides Authentication="false"